...
# save as png
filePath <- paste0(getwd(), "/coursera/ExData_Plotting1/plot4.png")
png(filePath, width = 480, height = 480, units = "px")

# set up the 2 x 2 grpah
par(mfcol=c(2,2))

# add global active power plot
with(dtHPC, plot(DateTime, Global_active_power, type = "l", xlab = "",
...
# add voltage plot
with(dtHPC, plot(DateTime, Voltage, type = "l"))

# add Global reactive power plot
with(dtHPC, plot(DateTime, Global_reactive_power, type = "l"))
